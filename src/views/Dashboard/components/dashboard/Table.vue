      ...
      <div class="overflow-x-auto">
        <table class="table">
          ...
          <thead class="tableHeader">
            <tr>
              <th class="p-2">
                <div class="theading">Source</div>
              </th>
              <th class="p-2">
                <div class="theading">Visitors</div>
              </th>
              <th class="p-2">
                <div class="theading">Revenues</div>
              </th>
              <th class="p-2">
                <div class="theading">Sales</div>
              </th>
              <th class="p-2">
                <div class="theading">Conversion</div>
              </th>
            </tr>
          </thead>
          <!-- Table body -->
          <tbody class="text-sm font-medium divide-y divide-slate-100 dark:divide-slate-700">
            ...
            <tr>
              <td class="p-2">
                <div class="box">
                  <svg class="imageLogo" width="36" height="36" viewBox="0 0 36 36">
            ...
            <tr>
              <td class="p-2">
                <div class="box">
                  <svg class="imageLogo sm:mr-3" width="36" height="36" viewBox="0 0 36 36">
